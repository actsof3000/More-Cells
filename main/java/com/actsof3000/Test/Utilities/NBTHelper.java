package com.actsof3000.Test.Utilities;
...
public class NBTHelper
{
    ...
    public static int[] getIntArray(ItemStack itemStack, String keyName)
    {
        ...
        if (!itemStack.stackTagCompound.hasKey(keyName))
        {
            setIntegerArray(itemStack, keyName, null);
        }

        return itemStack.stackTagCompound.getIntArray(keyName);
    }

    public static void setIntegerArray(ItemStack itemStack, String keyName, int[] keyValue)
    {
        initNBTTagCompound(itemStack);
